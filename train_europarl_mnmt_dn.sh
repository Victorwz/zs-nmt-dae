fairseq-preprocess --source-lang src --target-lang tgt \
    --trainpref data/EuroParl-raw-data/mnmt-dn/train.clean \
    --validpref data/EuroParl-raw-data/mnmt-dn/valid \
    --destdir data-bin/europarl_mnmt_denoising/ \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 fairseq-train \
     data-bin/europarl_mnmt_denoising \
    --task translation \
    ...
    --save-dir checkpoints/europarl_mnmt_denoising/